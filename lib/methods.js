Meteor.methods({
	...
	sendEmail : function(data){
		...
		//console.log(Audios.collection.findOne(relation.audio));
		relation.audio = "NO audio yet";//Audios.collection.findOne(relation.audio).versions.original.meta.pipeFrom;
		if (Meteor.isServer) {
			data = {
